...
<body>
  ...
  <div class="card-body">
    ...
    <form action="buscar_catalogo.php" method="">
      <input class="form-control mr-sm-2 " type="search" id="busqueda" placeholder="Buscar" aria-label="Search"><br>
      <!-- <a class="btn btn-warning  btn-block" type="submit" value="busqueda" > -->

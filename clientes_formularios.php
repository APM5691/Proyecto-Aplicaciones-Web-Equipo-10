        ...
        <form action="clientes_guardar.php" method="post" enctype='multipart/form-data'>
          ...
          <div class="form-group">
            ...
            <div class="form-check form-check-inline">
              ...
              <input class="form-check-input" type="radio" name="perfil" id="perfil" value="Administrador" disabled/>
            ...
            <div class="form-check form-check-inline">
              ...
              <input class="form-check-input" type="radio" name="perfil" id="perfil2" value="Tecnico" disabled/>
